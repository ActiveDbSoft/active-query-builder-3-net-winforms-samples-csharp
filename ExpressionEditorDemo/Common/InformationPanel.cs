    ...
    internal partial class InformationPanel : UserControl, IInformationPanel
    {
        ...
        public InfoIconLocation IconLocation
        {
            ...
            set
            {
                ...
                {
                    pictureBox1.Left = pnlMain.Width - pictureBox1.Width - Helpers.ScaleByCurrentDPI(3);
                    lbText.Left =Helpers.ScaleByCurrentDPI(3);
                    pictureBox1.Anchor = AnchorStyles.Right;
                }
                else if (_iconLocation == InfoIconLocation.Left)
                {
                    pictureBox1.Left = Helpers.ScaleByCurrentDPI(3);
                    lbText.Left = pnlMain.Width - lbText.Width - Helpers.ScaleByCurrentDPI(3);
        ...
        public bool ShowIcon
        {
            ...
            set
            {
                ...
                if (value)
                    lbText.Width = Width - Helpers.ScaleByCurrentDPI(26);
                else
                    lbText.Width = Width;
            }
        }
